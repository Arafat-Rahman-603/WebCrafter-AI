...
WebCrafter AI allows users to describe a website idea in natural language, and the system generates structured, responsive code (HTML, CSS, JavaScript,Tailwind CSS) using AI.
...
- 🤖 AI Website Generator (via prompts)
...
### 1. Clone Repository
```bash
git clone https://github.com/your-username/webcrafter-ai.git
cd webcrafter-ai
